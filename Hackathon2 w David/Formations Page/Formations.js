(function ($) {
  ...
  systems["4-4-2"]["y"] = [
    40, 145, 110, 110, 145, 235, 200, 200, 235, 290, 290,
  ];
  ...
  systems["4-4-1-1"]["y"] = [
    40, 145, 110, 110, 145, 235, 200, 200, 235, 290, 320,
  ];
  ...
  systems["4-3-3"]["y"] = [
    40, 145, 110, 110, 145, 210, 210, 210, 290, 290, 290,
  ];

  // Playing system: 4-1-2-1-2
  systems["4-1-2-1-2"] = new Array();
  systems["4-1-2-1-2"]["x"] = [
    149, 15, 93, 205, 283, 37, 149, 149, 260, 93, 205,
  ];
  systems["4-1-2-1-2"]["y"] = [
    40, 145, 110, 110, 145, 205, 180, 240, 205, 290, 290,
  ];
  ...
  var methods = {
    ...
    addYellowCard: function (id) {
      return this.each(function () {
        var yellowcard =
          '<div id="player-yellowcard-' +
          id +
          '" class="player-yellowcard"></div>';
    ...
    addRedCard: function (id) {
      return this.each(function () {
        var redcard =
          '<div id="player-redcard-' + id + '" class="player-redcard"></div>';
    ...
    substitutePlayer: function (outid, inid, nr, name) {
      return this.each(function () {
        ...
        $("#player-" + outid)
          .delay(1000)
          .animate({ left: "0px", opacity: 0 }, "slow", function () {
            $("#player-" + outid).remove();
          });
        ...
        var player =
          '<div id="player-' +
          inid +
          '" class="player cf" style="left: 0px; top: ' +
          ypos +
          ';">';
        player +=
          '<div class="player-nr">' +
        ...
        $("#player-" + inid)
          .delay(1000)
          .animate({ left: xpos, opacity: 1 }, "slow");
